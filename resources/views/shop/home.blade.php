...
@section('content')
<div class="w-full">
    {{-- HERO SECTION - 3-Image Slider --}}
    {{-- 
        INSTRUCTIONS TO ADD YOUR IMAGES:
        1. Place your 3 hero images in: storage/app/public/products/
        2. Name them: hero-slide-1.jpg, hero-slide-2.jpg, hero-slide-3.jpg
    ...
    --}}
    <section class="relative w-full bg-gray-200">
        <div id="hero-slider" class="relative w-full h-[750px] md:h-[850px] lg:h-[950px] xl:h-[1050px] overflow-hidden">
            ...
            <div class="hero-slide-item absolute inset-0 w-full h-full transition-opacity duration-700 ease-in-out" data-index="0" style="opacity: 1; z-index: 1;">
                <img 
                    ...
                    onerror="this.src='{{ asset('storage/products/hero-slide-1.png') }}'; this.onerror=function(){this.style.display='none';}"
                />
            </div>
            ...
            <div class="hero-slide-item absolute inset-0 w-full h-full transition-opacity duration-700 ease-in-out" data-index="1" style="opacity: 0; z-index: 0;">
                <img 
                    ...
                    class="w-full h-full object-cover"
                    style="display: block; width: 100%; height: 100%; object-fit: cover;"
                    onerror="this.src='{{ asset('storage/products/hero-slide-2.png') }}'; this.onerror=function(){this.style.display='none';}"
                />
            </div>
            ...
            <div class="hero-slide-item absolute inset-0 w-full h-full transition-opacity duration-700 ease-in-out" data-index="2" style="opacity: 0; z-index: 0;">
                <img 
                    ...
                    class="w-full h-full object-cover"
                    style="display: block; width: 100%; height: 100%; object-fit: cover;"
                    onerror="this.src='{{ asset('storage/products/hero-slide-3.png') }}'; this.onerror=function(){this.style.display='none';}"
                />
            </div>
            ...
            <button 
                id="hero-prev-btn"
                class="absolute left-4 top-1/2 -translate-y-1/2 z-30 bg-white/90 hover:bg-white text-gray-800 p-4 rounded-full shadow-xl transition-all duration-300 hover:scale-110"
            ...
            <button 
                id="hero-next-btn"
                class="absolute right-4 top-1/2 -translate-y-1/2 z-30 bg-white/90 hover:bg-white text-gray-800 p-4 rounded-full shadow-xl transition-all duration-300 hover:scale-110"
            ...
            <div class="relative z-20 container mx-auto px-4 md:px-6 lg:px-8 h-full">
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <div class="w-full max-w-4xl flex flex-col justify-center text-white text-center py-12 lg:py-0">
                        <h1 class="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 leading-tight">
                            Experience Cutting Edge<br>
                            <span class="text-white">Mobile Technology</span>
                        </h1>
                        
                        <p class="text-lg md:text-xl lg:text-2xl text-white/90 mb-10 leading-relaxed max-w-3xl mx-auto">
                            Explore the latest smartphones, premium cases, chargers, and accessories designed to keep you connected and stylish. Quality products, unbeatable prices, and fast delivery for tech enthusiasts and everyday users alike.
                        </p>
                    </div>
                </div>
            </div>
